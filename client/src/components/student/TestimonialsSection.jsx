...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
       ...
       <p className='md:text-base text-gray-500 mt-3'>Hear from our learner as they share their journeys of transformtaion, success and how our

       </p>
       <div className='grid grid-cols-2 sm:grid-cols-3 gap-8 mt-14'>
